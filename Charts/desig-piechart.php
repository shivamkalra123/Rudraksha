...
$query = "SELECT designation, COUNT(*) as count FROM joining WHERE start_date >= '$options[$selectedInterval]' GROUP BY designation";
...
<head>
    ...
    // Draw the box
    var textWidth = doc.getStringUnitWidth('Designation Distribution') * doc.internal.getFontSize() / doc.internal.scaleFactor;
